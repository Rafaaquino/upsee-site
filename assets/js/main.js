   ...
   ========================================*/
    ...
    $('#contact-us-message__form').submit(function(event) {
        ...
        form.find('input, textarea, select').each(function() {
            if ($(this).val().trim() === '') {
                valid = false;
                $(this).parent().after('<p class="error-message  mt-3 mb-0">Campo Obrigatório.</p>');
            }
        });
        ...
        setTimeout(function() {
            $.ajax({
                ...
                $('.loading-form').hide();
                form.append('<p class="success-message mt-3 mb-0">Mensagem enviada com sucesso.</p>');
            }).fail(function(data) {
                $('.loading-form').hide();
                form.append('<p class="error-message mt-3 mb-0">Erro. tente novamente mais tarde.</p>');
            });
        }, 1000);
    });
